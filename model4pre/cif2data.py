...
def write4cif(mof,cell,pos,chg,save_dir,charge = False):
    ...
    atoms_pred.set_cell(cell_data)
    atoms_pred.set_scaled_positions(pos_data)
    atoms_pred.write(save_dir + name + "_gcn.cif")
    ...
    if charge:
        ...
        lines[0] = "# generated by Guobin Zhao (Pusan National University, prof. Chung's group-MTAP)\n"
